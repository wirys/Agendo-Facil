...
export default function RenderTenantPage() {
  ...
  const handleSelectCategories = (selectedIds: Set<number>) => {
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center text-left p-5 mt-2 gap-2">
        ...
        <div className="flex flex-col gap-4">
          <SearchCategories onSelectCategories={handleSelectCategories} />
          <div className="flex flex-col gap-4 ">
      ...
      <JobList searchParams={{ query, categoryIds: Array.from(selectedCategoryIds) }} />
    </>
  );
}
